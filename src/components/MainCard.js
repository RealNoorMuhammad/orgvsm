...
function MainCard() {
    async function getCurrentAccount() {
      ...
      async function mint(mintAmount, currentAccount) {
        ...
        function validateMaxValueAndTriggerAlert(mintAmount, maxAmount) {
        ...
        if (validateMaxValueAndTriggerAlert(mintAmount, maxAmount)) {
            Swal.fire({
                icon: 'info',
        ...
        try {
            if (typeof window.ethereum === 'undefined') {
                ...
                if (typeof currentAccount === 'undefined') { 
                    ...
                    if (merkleHelper.verifyLeaf(currentAccount)) {
                        Swal.fire({
                            title: 'Would you like to mint 1 or 2 tokens?',
                            input: 'text',
                            inputAttributes: {
                              autocapitalize: 'off'
                            },
                            ...
                            preConfirm: (mintAmount) => {
                              mint(mintAmount, currentAccount)
                            },
                        ...
                        Swal.fire({
                            icon: 'error',
                            title: 'Address is not in whitelist'
                        })
                    }
